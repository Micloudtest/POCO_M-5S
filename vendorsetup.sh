...
if [ -f "$(gettop)/bootable/recovery/orangefox.cpp" ]; then
	...
	if [ "$1" = "$FDEVICE" ] || [  "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
	  # Version / Maintainer infos
		...
		export TARGET_DEVICE_ALT="rosemary,secret,maltose"
		export LC_ALL="C"
	  	...
	  	#export OF_FL_PATH1="/system/etc/flashlight" # See /init.recovery.mt6768.rc for more information
	  	...
	  	export OF_WIPE_METADATA_BEFORE_DATAFORMAT=1
